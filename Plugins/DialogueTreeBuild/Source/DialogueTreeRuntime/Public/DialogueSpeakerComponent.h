...
/**
* Delegate used to notify when the menu is shown. 
*/
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
	FOnMenuShown,
	UUserWidget*,
...
/**
* Delegate used to notify when the menu is closed. 
*/
...
public:
	...
	*/
	// UFUNCTION(BlueprintCallable, Category = "Dialogue")
	// void StartOwnedDialogue(TArray<FGameplayTag> InSpeakerTags);
	...
	* 
	* @param InDialogue - UDialogue*, the dialogue to start. 
	* @param InSpeakers - TArray<FGameplayTag> the conversing
	* speakers. 
	*/
	UFUNCTION(BlueprintCallable, Category = "Dialogue")
	...
	/**
	* Override this to perform UI Action
	*/
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "Dialogue")
	void ShowDialogueMenu(ADialogueController* InController);
